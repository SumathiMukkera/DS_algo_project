...
Given The user is in the "Implimentation of Queue in Python" page
...
Scenario: Verify that User is able to navigate to "Paractice Questions" page
Given The user is in the "Implementation of Queue in Python" page
...
Scenario: Verify that User is able to navigate to "Implimentation of Queue in Python" page
