Feature: Title of your feature
   ...
   Given:	user is on the registrationpage
   When:	The user clicks Register button after entering  with
   valid username, password and password confirmation in related textboxes 
   Then:	The user should be redirected to Home Page of DS Algo with message
   New Account Created. You are logged in as <ID>
   ...
   Scenario:Verify that user receives error message for invalid password field during registration
    ...
    When:The user clicks Register button after entering a username with spacebar characters other than
 digits and @/./+/-/_
     Then:The user is not able to see error msg after entering invalid data"
